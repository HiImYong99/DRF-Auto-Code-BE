...
```
사용자가 30분 동안 페이지 새로고침을 하지 않으면 토큰이 만료되어 사용자는 자동으로 로그아웃이 됩니다.
...
- JWT 인증 방식을 적용해 봤는데 CORS와 관련한 에러들을 경험하면서 CORS에 관련한 이슈는 다음번에 보다 유연하게 대처할 수 있을 것 같습니다.
